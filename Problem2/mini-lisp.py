...
""" car gives you the first element, and ' indicates is not a function
cdr gets all except the first element
cons takes the element and puts it at the beginning of the list
"""
